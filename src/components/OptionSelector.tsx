      ...
      {type === 'visual' && (
        <div className="flex flex-wrap gap-4">
          {options.map((opt) => {
            ...
            else if (opt.id === '16:9') visualElement = <div className="w-16 h-9 border-2 border-current rounded-sm"></div>;
            else if (opt.id === '9:16') visualElement = <div className="w-7 h-12 border-2 border-current rounded-sm"></div>;
